        ...
        <div class="container">
            <div class="media" style="margin-bottom: 35px;">
                <div class="media-left">
                    <img src="https://group1422.wordpress.com/wp-content/uploads/2025/10/rectangle-21-2-e1760948548711.png" class="media-object" style="border-radius: 10px;">
                </div>
                <div class="media-body">
                    <h3>Imię i nazwisko</h3>
                    <div style="margin-top: 10px;">
                        <span style="color: #60646A; font-size: 14px;">
